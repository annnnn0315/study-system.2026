...
export function renderTodayDashboard({ container, plan, onToggleTask }) {
  ...
  const renderIeltsTaskSection = (label, key, tasks, emptyMessage) => {
    if (!tasks.length) {
    ...
    <div class="today-layout">
      <div class="today-column">
        ...
        <div class="metric-card">
          ...
          ${renderIeltsTaskSection("IELTS", "carry-over-ielts", carryOverTasks, "")}
          ${renderLawTaskList("Law subject", lawCarryOverTasks, "")}
          ...
          ${renderIeltsTaskSection("IELTS", "planned-ielts", plannedTasks, "No planned IELTS tasks for today.")}
          ${renderLawTaskList("Law subject", plannedLawTasks, "No scheduled law tasks for today.")}

          ${extraPracticeTasks.length ? `<h3 class="section-title">Extra practice</h3>${renderIeltsTaskSection("IELTS", "extra-practice-ielts", extraPracticeTasks, "")}` : ""}
        </div>
      </div>
